...
const Signup = () => {
  ...
  return (
    <>
      <section className='w-full h-[100vh] flex items-center justify-center bg-[var(--bg-body)] px-4'>
        ...
        <article className='flex items-center md:h-[90vh] md:w-210 z-10 shadow-3xl shadow-[var(--shadow-md)] rounded-3xl'>
